...
def handle_request_add_stage():
    ...
    # Call the facade method
    try:
        result = facade.add_stage(data['project_id'], data['title_id'], data['stage_name'], data['username'], data.get('apartment_number', None))
        return jsonify({'result': result})
    except Exception as e:
...
def handle_request_add_mission():
    ...
    # Call the facade method
    try:
        result = facade.add_mission(data['project_id'], data['title_id'], data['stage_id'], data['mission_name'], data['username'], data.get('apartment_number', None))
        return jsonify({'result': result})
    except Exception as e:
...
def handle_request_edit_project_name():
    ...
    # Call the facade method
    try:
        result = facade.edit_project_name(data['project_id'], data['new_project_name'], data['username'])
        return jsonify({'result': result})
    except Exception as e:
...
def handle_request_edit_stage_name():
    ...
    # Call the facade method
    try:
        result = facade.edit_stage_name(data['project_id'], data['title_id'], data['stage_id'], data['new_stage_name'], data['username'], data.get('apartment_number', None))
        return jsonify({'result': result})
    except Exception as e:
...
def handle_request_edit_mission_name():
    ...
    # Call the facade method
    try:
        result = facade.edit_mission_name(data['project_id'], data['title_id'], data['stage_id'], data['mission_id'], data['new_mission_name'], data['username'], data.get('apartment_number', None))
        return jsonify({'result': result})
    except Exception as e:
...
def handle_request_set_mission_status():
    ...
    # Call the facade method
    try:
        facade.set_mission_status(data['project_id'], data['title_id'], data['stage_id'], data['mission_id'], data['new_status'], data['username'], data.get('apartment_number', None))
        return jsonify({'result': 'success'})
    except Exception as e:
...
def handle_request_get_all_missions():
    ...
    # Call the facade method
    try:
        result = facade.get_all_missions(data['project_id'], data['title_id'], data['stage_id'], data['username'], data.get('apartment_number', None))
        return jsonify({'result': result})
    except Exception as e:
...
def handle_request_get_all_stages():
    ...
    # Call the facade method
    try:
        result = facade.get_all_stages(data['project_id'], data['title_id'], data['username'], data.get('apartment_number', None))
        return jsonify({'result': result})
    except Exception as e:
...
def handle_request_assign_project_to_user():
    ...
    # Call the facade method
    try:
        facade.assign_project_to_user(data['project_id'], data['permission_type'], data['assigning_username'], data['username_to_assign'])
        return jsonify({'result': 'success'})
    except Exception as e:
...
def handle_request_edit_comment_in_mission():
    ...
    # Call the facade method
    try:
        result = facade.edit_comment_in_mission(data['project_id'], data['title_id'], data['stage_id'], data['mission_id'], data['comment'], data['username'], data.get('apartment_number', None))
        return jsonify({'result': result})
    except Exception as e:
...
def handle_request_remove_stage():
    ...
    # Call the facade method
    try:
        result = facade.remove_stage(data['project_id'], data['title_id'], data['stage_id'], data['username'], data.get('apartment_number', None))
        return jsonify({'result': result})
    except Exception as e:
...
def handle_request_remove_mission():
    ...
    # Call the facade method
    try:
        result = facade.remove_mission(data['project_id'], data['title_id'], data['stage_id'], data['mission_id'], data['username'], data.get('apartment_number', None))
        return jsonify({'result': result})
    except Exception as e:
...
def handle_request_set_green_building():
    ...
    # Call the facade method
    try:
        facade.set_green_building(data['project_id'], data['title_id'], data['stage_id'], data['mission_id'], data['is_green_building'], data['username'], data.get('apartment_number', None))
        return jsonify({'result': 'success'})
    except Exception as e:
...
def handle_request_set_stage_status():
    ...
    # Call the facade method
    try:
        facade.set_stage_status(data['project_id'], data['title_id'], data['stage_id'], data['new_status'], data['username'])
        return jsonify({'result': 'success'})
    except Exception as e:
...
def handle_request_get_all_assigned_users_in_project():
    ...
    # Call the facade method
    try:
        result = facade.get_all_assigned_users_in_project(data['project_id'], data['username'])
        return jsonify({'result': result})
    except Exception as e:
...
def handle_request_set_urgency():
    ...
    # Call the facade method
    try:
        facade.set_urgency(data['project_id'], data['building_fault_id'], data['new_urgency'], data['username'])
        return jsonify({'result': 'success'})
    except Exception as e:
...
def handle_request_add_building_fault():
    ...
    # Call the facade method
    try:
        result = facade.add_building_fault(data['project_id'], data['name'], data['username'], data['floor_number'], data['apartment_number'], data.get('urgency', Urgency.LOW))
        return jsonify({'result': result})
    except Exception as e:
...
def handle_request_remove_building_fault():
    ...
    # Call the facade method
    try:
        result = facade.remove_building_fault(data['project_id'], data['build_fault_id'], data['username'])
        return jsonify({'result': result})
    except Exception as e:
...
def handle_request_set_build_fault_status():
    ...
    # Call the facade method
    try:
        facade.set_build_fault_status(data['project_id'], data['build_fault_id'], data['new_status'], data['username'])
        return jsonify({'result': 'success'})
    except Exception as e:
...
def handle_request_remove_user_from_project():
    ...
    # Call the facade method
    try:
        result = facade.remove_user_from_project(data['project_id'], data['username_to_remove'], data['removing_user'])
        return jsonify({'result': result})
    except Exception as e:
