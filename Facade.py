...
class Facade:
    ...
    def set_mission_status(
        ...
        return self.controller.set_mission_status(
            project_id,
            title_id,
            stage_id,
            mission_id,
    ...
    def get_all_missions(
        ...
        return self.controller.get_all_missions(
    ...
    def get_all_stages(
        ...
        return self.controller.get_all_stages(
            project_id, title_id, username, apartment_number
        )
    ...
    def assign_project_to_user(
        ...
        return self.controller.assign_project_to_user(
    ...
    def edit_comment_in_mission(
        ...
        return self.controller.edit_comment_in_mission(
            project_id,
            title_id,
            stage_id,
            mission_id,
    ...
    def set_green_building(
        ...
        return self.controller.set_green_building(
            project_id,
            title_id,
            stage_id,
            mission_id,
    ...
    def set_stage_status(
        ...
        return self.controller.set_stage_status(
    ...
    def set_urgency(
        ...
        return self.controller.set_urgency(
