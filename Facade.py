...
class Facade:
    ...
    def add_mission(
        self, project_id: UUID, stage_id: UUID, mission_name: str, username: str
    ) -> Mission:
    ...
    def edit_stage_name(
        self, project_id: UUID, stage_id: UUID, new_stage_name: str, username: str
    ) -> str:
        return self.controller.edit_stage_name(
            project_id, stage_id, new_stage_name, username
        )
    ...
    def edit_mission_name(
        ...
        return self.controller.edit_mission_name(
            project_id, stage_id, mission_id, new_mission_name, username
        )
    ...
    def set_mission_status(
        ...
        return self.controller.set_mission_status(
            project_id, stage_id, mission_id, new_status, username
        )
    ...
    def edit_comment_in_mission(
        ...
        return self.controller.edit_comment_in_mission(
            project_id, stage_id, mission_id, comment, username
        )
    ...
    def remove_mission(
        self, project_id: UUID, stage_id: UUID, mission_id: UUID, username: str
    ):
        return self.controller.remove_mission(
            project_id, stage_id, mission_id, username
        )
    ...
    def set_green_building(
        ...
        return self.controller.set_green_building(
            project_id, stage_id, mission_id, is_green_building, username
        )
